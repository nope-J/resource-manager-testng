...
public class SipGroupTestng {
	...
	public void sipGroupTestng() {
		...
		assert sipGroupCreate1!=null && sipGroupCreate2!=null && sipGroupCreate3!=null : "ÐÂÔöSipGroupÊ§°Ü";

		List<CtiLinkSipGroup> list = listSipGroup();
		assert list!=null:"²éÑ¯sipGroupÊ§°Ü";
		...
		assert success0==0:"ÐÞ¸ÄsipGroupÊ§°Ü";
